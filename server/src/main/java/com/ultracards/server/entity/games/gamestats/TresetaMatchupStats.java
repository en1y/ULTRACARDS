...
public class TresetaMatchupStats {
    ...
    public TresetaMatchupStats(String gameConfig, Long relatedUserId, int played, int wins) {
    ...
    public static String configKey(TresetaGameConfig gameConfig) {
